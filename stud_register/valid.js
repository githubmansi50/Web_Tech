...
{ 
   ...
   {
     alert( "Fill FatherName Details!!" );
     document.StudentRegistration.fathername.focus() ;
     return false;
   }
   
	if( document.StudentRegistration.surname.value == "" )
   	{
     alert( "Fill Surname Details!!" );
     document.StudentRegistration.surname.focus() ;
     return false;
   	}
   ...
   if( document.StudentRegistration.SelectCourse.value == "-1" )
   {
